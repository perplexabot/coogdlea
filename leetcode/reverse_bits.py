...
class Solution:
    ...
    def reverseBits(self, n):
        ...
        b_rev_str = ''.join(b_rev)
        int_rev = int(b_rev_str, base=2)
        return int_rev


inps = [
    int('00000010100101000001111010011100', base=2),
    int('11111111111111111111111111111101', base=2),
]

sol = Solution()
for inp in inps:
    print(f"Reversing {inp} [{bin(inp)}]")
    ans = sol.reverseBits(inp)
    print(f" got: {ans} [{bin(ans)}]")
