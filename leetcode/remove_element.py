...
class Solution:
    def removeElement(self, nums, val):
        ...
        :rtype: int
        """
        # 1 2 4 1 53 1 67 1 4 1 46 1, let the value to be removed be 1
...
lists = [ [[3,2,2,3], 3], [[0,1,2,2,3,0,4,2], 2], [[1],1], [[1,1],1], [[1],2], [[1,2,3],1], [[1,3,4],4] ]

s = Solution()

for l in lists:
    lst, val = l[0], l[1]
    print("Trying list: " + str(lst) )
    print(" With a val: " + str(val) )
    ans = s.removeElement(lst, val)
    print(" List after: " + str(lst) )
    print(" New size: " + str(ans) )
