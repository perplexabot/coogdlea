...
A:
    Can moves be such that if all layed out, two win?   ->  no according to rules
    Can moves be more than 9    ->  no according to rules
    If moves is empty   -> return Pending
    If moves < 5        -> return Pending
...
class Solution:
    def tictactoe(self, moves: list[list[int]]) -> str:
        ...
        if (
            board[0][0] == board[1][1] == board[2][2] == "A"
            or board[2][0] == board[1][1] == board[0][2] == "A"
        ):
            return "A"

        if (
            board[0][0] == board[1][1] == board[2][2] == "B"
            or board[2][0] == board[1][1] == board[0][2] == "B"
        ):
            return "B"
